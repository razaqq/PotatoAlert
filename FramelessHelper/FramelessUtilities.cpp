...
[[maybe_unused]] void Utilities::blurImage(QPainter *painter, QImage &blurImage, const qreal radius, const bool quality, const bool alphaOnly, const int transposed)
{
...
[[maybe_unused]] void Utilities::blurImage(QImage &blurImage, const qreal radius, const bool quality, const int transposed)
{
...
[[maybe_unused]] QRect Utilities::alignedRect(const Qt::LayoutDirection direction, const Qt::Alignment alignment, const QSize &size, const QRect &rectangle)
{
...
[[maybe_unused]] QRect Utilities::getScreenAvailableGeometry(const QWindow *window)
{
	if (window)
	{
...
[[maybe_unused]] bool Utilities::shouldUseWallpaperBlur()
{
